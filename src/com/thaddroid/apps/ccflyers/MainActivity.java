	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TableRow.OnClickListener click = new TableRow.OnClickListener(){
			...
			public void onClick(View v) {
				...
				bundle.putString("image_src", s[index].getImgSrc());
			...
			if(checkArray!=null){
				for(int m:checkArray){
					...
					for(whichURL=0; whichURL<4; whichURL++ ){
						...
						Document document = Jsoup.connect(s[m].getURL(whichURL)).get();
